...
public class DeleteUserTest extends BaseTest{
	...
	public void deleteUserTest() {
		...
		Assert.assertEquals(responsePost.jsonPath().getString("name"), "paul");
		...
		Response responseDelete = restClient.delete(BASE_URL_GOREST, GOREST_USERS_END_POINT+"/"+userId, null, null, AuthType.BEARER_TOKEN, ContentType.JSON);
